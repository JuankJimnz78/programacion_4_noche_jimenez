...
fun main() {
    ...
    CatalogoProductos.agregarProducto("Monitor 29\"",      456.10,  5, 2)
    CatalogoProductos.agregarProducto("USB 3.2",            52.10,  6, 4)
    ...
    println("\n=== Dos productos con 15% descuento ===")
    CatalogoProductos.listar()
        .take(2)
