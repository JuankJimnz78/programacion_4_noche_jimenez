...
export function Paso1() {
  ...
  return (
    <View style={styles.contenedor}>
      <Text style={styles.titulo}>Conexión al servicio de precios</Text>

      <View style={[styles.tarjeta, { borderColor: colorEstado }]}>
        <Text style={[styles.estado, { color: colorEstado }]}>
          {estadoTexto}
        </Text>
        <Text style={styles.detalle}>servicio-precios · PreciosEC API</Text>
      </View>
