...
import 'package:modulo10_riverpod_mp/screens/pantalla_productos.dart';
...
// │  2  Paso 2  NotifierProvider + lista de productos               │
...
void main() {
  runApp(const ProviderScope(child: AppPreciosEC()));
}

class AppPreciosEC extends StatelessWidget {
  const AppPreciosEC({super.key});
...
class _Paso1 extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Productos en catálogo')),
      body: Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('$count', style: Theme.of(context).textTheme.displayLarge),
            const Text('productos activos'),
          ],
        ),
      ),
