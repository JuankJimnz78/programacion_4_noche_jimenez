...
/// Fila de una sucursal dentro de un comercio (equivalente didáctico de
/// FilaEstado): muestra si tiene precios actualizados o no.
class FilaSucursal extends StatelessWidget {
  final String nombre;
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Text(
              activo ? 'Precios al día' : 'Sin datos',
              style: TextStyle(
                fontSize:   11,
