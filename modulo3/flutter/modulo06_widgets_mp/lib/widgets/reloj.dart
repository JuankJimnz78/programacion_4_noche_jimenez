...
/// Cronómetro didáctico: en PreciosEC representa el tiempo transcurrido
/// desde la última sincronización de precios con los comercios afiliados.
...
class _RelojState extends State<Reloj> {
  ...
  bool _pausado = false;
  int vueltas = 0;
  final List<int> _tiemposVuelta = []; // guarda el _segundos de cada sincronización
  ...
  // Color cambia según cuánto tiempo lleva sin sincronizar
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          _pausado ? 'Pausado' : 'Monitoreando precios',
          style: TextStyle(fontSize: 12, color: Colors.grey.shade600),
        ),
        if (_tiemposVuelta.isNotEmpty) ...[
          const SizedBox(height: 8),
          Text(
            'Sincronización $vueltas: ${_formatoDe(_tiemposVuelta.last)}',
