      ...
      body: ListView(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              'Seguridad • John Reimberg revela qué ocurrió con el cuerpo de Carlos Alberto Suástegui, asesinado en el aeropuerto de Guayaquil John Reimberg explicó qué ocurrió cuerpo de Carlos Alberto Suástegui, cabecilla de Los Águilas asesinado en el aeropuerto de Guayaquil.Este contenido ha sido publicado originalmente por EL COMERCIO. Si vas a hacer uso del mismo, por favor, cita la fuente y haz un enlace hacia la nota original en la dirección: https://www.elcomercio.com/',
              textAlign:
